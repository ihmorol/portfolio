  ...
  return (
    <>
      <div className="fixed left-6 bottom-12 hidden xl:flex flex-col items-center gap-4 z-40">
        <div className="bg-surface/80 backdrop-blur border border-white/10 rounded-full p-1.5 w-10 h-64 flex flex-col justify-between items-center relative">
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest py-4 [writing-mode:vertical-rl] [text-orientation:mixed]">SKILLS</span>
      ...
      <div className="fixed right-8 bottom-12 hidden xl:flex flex-col items-center z-40">
        <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] transform rotate-180 [writing-mode:vertical-rl] [text-orientation:mixed] flex gap-8">
