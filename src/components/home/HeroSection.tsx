    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 lg:gap-5">
          ...
          <Link 
            href="/projects" 
            className="group relative w-full sm:w-40 md:w-48 lg:w-52 aspect-square bg-gradient-to-br from-pink-400 to-rose-500 rounded-2xl flex flex-col items-center justify-center gap-4 transition-transform hover:scale-[1.02] cursor-pointer flex-shrink-0"
          >
            <span 
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-6">
        <Link 
          href="/resume.pdf" 
          target="_blank"
          className="flex items-center justify-center gap-3 bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-xl transition-colors group"
        >
          <span 
