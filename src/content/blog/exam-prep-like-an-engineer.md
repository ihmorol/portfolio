...
1. **Master index and study plan.** The reading order, plus an explicit list of what to memorize versus what to skip. Deciding what to leave out is half the value.
...
3. **Solved past papers.** Real questions with worked answers you can pattern-match against, instead of a vague instruction to review the slides.
